              ...
              <Card.Body className="p-0">
                <div className="border-bottom p-3">
                  ...
                  <NavItem
                    ...
                    text="Estatuto FAO"
                    handleElement={() => {
                      if (Array.isArray(elements) && elements[2]) {
                  ...
                  <NavItem
                    ...
                    text="Reglamento FAO"
                    handleElement={() => {
                      if (Array.isArray(elements) && elements[3]) {
                        setElement(elements[3])
                        setShow(true)
                      }
                    }}
                  />
                  <NavItem
                    icon={<IconBuilding />}
                    text="Entidades afiliadas"
                    handleElement={() => {
                      if (Array.isArray(elements) && elements[4]) {
                        setElement(elements[4])
                        setShow(true)
                      }
                    }}
                  />
                  <NavItem
                    ...
                    text="Sede FAO"
                    handleElement={() => {
                      if (Array.isArray(elements) && elements[5]) {
                        setElement(elements[5])
                        setShow(true)
                      }
                    }}
                  />
                ...
                <div className="p-3">
                  <NavItem
                    ...
                    text="Listado clubes"
                    handleElement={() => {
                      if (Array.isArray(elements) && elements[6]) {
                        setElement(elements[6])
                        setShow(true)
                      }
                    }}
                  />
                  <NavItem
                    ...
                    text="Rating"
                    handleElement={() => {
                      if (Array.isArray(elements) && elements[7]) {
                        setElement(elements[7])
                        setShow(true)
                      }
                    }}
                  />
...
function NavItem({ icon, text, handleElement }) {
  return (
    <div
      id="nav-item"
      className="d-flex align-items-center py-2 px-3 text-decoration-none text-dark hover-bg-light cursor-pointer"
